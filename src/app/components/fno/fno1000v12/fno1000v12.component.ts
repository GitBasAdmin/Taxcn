...
@Component({
  selector: 'app-fno1000v12',
  templateUrl: './fno1000v12.component.html',
  styleUrls: ['./fno1000v12.component.css']
})
export class Fno1000v12Component implements AfterViewInit, OnInit, OnDestroy {
  sessData:any;
  userData:any;
  litType:any;
  getAppeal:any;
