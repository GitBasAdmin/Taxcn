...
@Component({
  selector: 'app-fno1000v13',
  templateUrl: './fno1000v13.component.html',
  styleUrls: ['./fno1000v13.component.css']
})
export class Fno1000v13Component implements AfterViewInit, OnInit, OnDestroy {
  sessData:any;
  userData:any;
  litType:any;
  getAppeal:any;
