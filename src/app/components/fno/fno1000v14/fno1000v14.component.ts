...
@Component({
  selector: 'app-fno1000v14',
  templateUrl: './fno1000v14.component.html',
  styleUrls: ['./fno1000v14.component.css']
})
export class Fno1000v14Component implements AfterViewInit, OnInit, OnDestroy {
  sessData:any;
  userData:any;
  litType:any;
  getAppeal:any;
      ...
      if(this.result.jp_flag==1){
        ...
        this.http.post('/'+this.userData.appName+'ApiUTIL/API/getData', student).subscribe(
          ...
          if(productsJson.length){
            ...
            this.result.prison = this.result.noticeto_name = '';
          }
          },
          (error) => {}
        )
