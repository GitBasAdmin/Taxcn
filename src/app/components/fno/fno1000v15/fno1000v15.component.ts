...
@Component({
  selector: 'app-fno1000v15',
  templateUrl: './fno1000v15.component.html',
  styleUrls: ['./fno1000v15.component.css']
})
export class Fno1000v15Component implements AfterViewInit, OnInit, OnDestroy {
  sessData:any;
  userData:any;
  litType:any;
  getAppeal:any;
