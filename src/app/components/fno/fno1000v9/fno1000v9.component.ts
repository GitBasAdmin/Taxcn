...
@Component({
  selector: 'app-fno1000v9',
  templateUrl: './fno1000v9.component.html',
  styleUrls: ['./fno1000v9.component.css']
})
export class Fno1000v9Component implements AfterViewInit, OnInit, OnDestroy {
  sessData:any;
  userData:any;
  litType:any;
  getAppeal:any;
