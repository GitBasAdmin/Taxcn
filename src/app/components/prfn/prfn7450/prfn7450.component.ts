...
@Component({
  selector: 'app-prfn7450,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prfn7450.component.html',
  styleUrls: ['./prfn7450.component.css']
})


export class Prfn7450Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prfn7450',{static: true}) prfn7450 : ElementRef;
...
this.http.post('/'+this.userData.appName+'ApiUTIL/API/getData', student , {headers:headers}).subscribe(
  ...
  this.pprint_by = '1';
  this.getPrintLine = [{id:'1',text:'ไม่เว้น'},{id:'3',text:'3'},{id:'5',text:'5'},{id:'8',text:'8'}];
  this.pprint_line = '1';
  this.getPrcvFlag = [{id:'0',text:'ทั้งหมด'},{id:'1',text:'รับเงินก่อน 1 ตุลาคม 2562'},{id:'2',text:'รับเงินตั้งแต่ 1 ตุลาคม 2562'}];
  this.prcv_flag = '2';
  this.setDefPage();
  }
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "pdate_end" : myExtObject.conDate($("#txt_date_end").val()),
         ...
         "pflag" : this.pflag,
         "pprint" : this.result.pprint,
         "pprint_by" : this.result.pprint_by,
         "pprint_line" : this.pprint_line,
       });
