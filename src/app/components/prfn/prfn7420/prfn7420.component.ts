...
@Component({
  selector: 'app-prfn7420,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prfn7420.component.html',
  styleUrls: ['./prfn7420.component.css']
})


export class Prfn7420Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prfn7420',{static: true}) prfn7420 : ElementRef;
