...
@Component({
  selector: 'app-prfn7300,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prfn7300.component.html',
  styleUrls: ['./prfn7300.component.css']
})


export class Prfn7300Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prfn7300',{static: true}) prfn7300 : ElementRef;
  ...
  ngOnInit(): void {
    ...
    //----------------------end pcase_type -------------------
    this.getCompensType = [{id:'1',text:'1  ค่าป่วยการล่าม'},{id:'2',text:'2  ตอบแทนนักจิตวิทยา'},{id:'3',text:'3  ตอบแทนพยาน'},{id:'4',text:'4  ผู้ประนอม'},{id:'5',text:'5  สักขีพยาน'}];
    this.setDefPage();
  }
...
var paramData = JSON.stringify({
  "psel" : this.result.psel ? this.result.psel.toString() : '1',
  ...
  "pno1" : this.result.pno1 ? this.result.pno1.toString() : '',
  "pno2" : this.result.pno2 ? this.result.pno2.toString() : '',
  "pyy" : this.result.pyy ? this.result.pyy.toString() : '',

  "pcompens_type" : this.result.pcompens_type ? this.result.pcompens_type : '',
});
