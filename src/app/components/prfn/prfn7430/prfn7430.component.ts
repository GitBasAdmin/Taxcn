...
@Component({
  selector: 'app-prfn7430,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prfn7430.component.html',
  styleUrls: ['./prfn7430.component.css']
})


export class Prfn7430Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prfn7430',{static: true}) prfn7430 : ElementRef;
