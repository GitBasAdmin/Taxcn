...
@Component({
  selector: 'app-prfn7440,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prfn7440.component.html',
  styleUrls: ['./prfn7440.component.css']
})


export class Prfn7440Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prfn7440',{static: true}) prfn7440 : ElementRef;
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "ptoday" : this.result.txt_ptoday ? myExtObject.conDate(this.result.txt_ptoday) : '',
         "chk" : this.result.chk ? this.result.chk.toString() : '1',
         "title" : this.result.title ? this.result.title.toString() : '',
         "id" : this.result.id ? this.result.id.toString() : '',
         "yy" : this.result.yy ? this.result.yy.toString() : '',
