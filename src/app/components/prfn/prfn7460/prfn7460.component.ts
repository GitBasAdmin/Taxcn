...
@Component({
  selector: 'app-prfn7460,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prfn7460.component.html',
  styleUrls: ['./prfn7460.component.css']
})


export class Prfn7460Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prfn7460',{static: true}) prfn7460 : ElementRef;
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "pdate_end" : this.result.txtEndDate ? myExtObject.conDate(this.result.txtEndDate) : '',
         ...
         "pprint" : this.result.pprint ? this.result.pprint.toString() : '',
         "prcv_flag" : this.result.prcv_flag ? this.result.prcv_flag.toString() : '',
