...
@Component({
  selector: 'app-prkr0800,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prkr0800.component.html',
  styleUrls: ['./prkr0800.component.css']
})


export class Prkr0800Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prkr0800',{static: true}) prkr0800 : ElementRef;
