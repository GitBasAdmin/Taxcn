...
@Component({
  selector: 'app-prkr0500,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prkr0500.component.html',
  styleUrls: ['./prkr0500.component.css']
})


export class Prkr0500Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prkr0500',{static: true}) prkr0500 : ElementRef;
