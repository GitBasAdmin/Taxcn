...
@Component({
  selector: 'app-prkr0700,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prkr0700.component.html',
  styleUrls: ['./prkr0700.component.css']
})


export class Prkr0700Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prkr0700',{static: true}) prkr0700 : ElementRef;
  ...
  ngOnInit(): void {
    ...
    //----------------------end pcase_type -------------------
    this.getFlag = [{id:'1',text:'ขอคัดถ่าย ตั้งแต่วันที่'},{id:'2',text:'รับเอกสาร ตั้งแต่วันที่'}];
    this.setDefPage();
  }
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "pflag" : this.result.pflag.toString(),
        ...
        // "pcon_flag" : this.result.pcon_flag ? this.result.pcon_flag.toString() : '',
       });
