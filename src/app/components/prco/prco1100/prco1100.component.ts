...
@Component({
  selector: 'app-prco1100,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prco1100.component.html',
  styleUrls: ['./prco1100.component.css']
})


export class Prco1100Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prco1100',{static: true}) prco1100 : ElementRef;
...
this.getContentType = [{id:'1',text:'1  สมุดรับประเด็น'},{id:'2',text:'2  สมุดส่งประเด็นคืน'},{id:'3',text:'3  สมุดส่งประเด็น'},{id:'4',text:'4  สมุดรับประเด็นคืน'}];
