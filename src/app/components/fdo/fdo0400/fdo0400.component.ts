...
@Component({
  selector: 'app-fdo0400,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fdo0400.component.html',
  styleUrls: ['./fdo0400.component.css']
})


export class Fdo0400Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
  ...
  // @ViewChild('fdo0400',{static: true}) case_type : ElementRef;
  ...
  ngOnDestroy(): void {
    ...
    LoadData() {
      ...
      confirmBox.setTitle('ข้อความแจ้งเตือน');
        ...
        console.log(student);
        this.http.post('/'+this.userData.appName+'ApiDO/API/KEEPB/fdo0400', student ).subscribe(
          posts => {
            ...
            if(productsJson.result == 1){
              ...
              // this.checklist2 = this.posts;
                if(productsJson.length)
                  this.posts.forEach((x : any ) => x.edit0400 = false);
