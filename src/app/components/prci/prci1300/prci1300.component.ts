...
@Component({
  selector: 'app-prci1300,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prci1300.component.html',
  styleUrls: ['./prci1300.component.css']
})


export class Prci1300Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  posts: any;
  ...
  @ViewChild('prci1300', { static: true }) prci1300: ElementRef;
  ...
  ngOnInit(): void {
    ...
    //----------------------end pcase_type -------------------
    this.getConType = [{ id: '2', text: 'ผู้ประนอม' }, { id: '1', text: 'ผู้พิพากษา' }];
    this.result.pcon_type = '2';
  ...
  tabChangeInput(name: any, event: any) {
    ...
    } else if (this.result.pcon_type == 1) {
      var student = JSON.stringify({
        "table_name": "pjudge",
        "field_id": "judge_id",
