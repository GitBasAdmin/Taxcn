...
@Component({
  selector: 'app-prci1500,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prci1500.component.html',
  styleUrls: ['./prci1500.component.css']
})


export class Prci1500Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prci1500',{static: true}) prci1500 : ElementRef;
