...
@Component({
  selector: 'app-prci2700,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prci2700.component.html',
  styleUrls: ['./prci2700.component.css']
})


export class Prci2700Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prci2700',{static: true}) prci2700 : ElementRef;
    ...
    printReport(type:any){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "plit_name" : this.result.plit_name ? this.result.plit_name.toString() : '',
        "pflag" : type.toString(),
       });
