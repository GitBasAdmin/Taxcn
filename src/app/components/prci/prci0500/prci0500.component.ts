...
@Component({
  selector: 'app-prci0500,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prci0500.component.html',
  styleUrls: ['./prci0500.component.css']
})


export class Prci0500Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  ptitle = 'datatables';
  ...
  @ViewChild('prci0500',{static: true}) prci0500 : ElementRef;
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "pdep_code" : this.result.pdep_code ? this.result.pdep_code : '',
         ...
         "chk" : this.result.chk ? this.result.chk : '',
