...
@Component({
  selector: 'app-fsc0200,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fsc0200.component.html',
  styleUrls: ['./fsc0200.component.css']
})


export class Fsc0200Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
 ...
 ngAfterViewInit(): void {
  ...
  callDataHead(objData:any){//ส่งไปเรียก fsc0200-head
    console.log(objData)
    this.callHead = objData;
  }

  fnDataHead(objData:any){//รับจาก fsc0200-head
    console.log(objData)
    setTimeout(() => {
