...
@Component({
  selector: 'app-prca2400,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prca2400.component.html',
  styleUrls: ['./prca2400.component.css']
})


export class Prca2400Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prca2400',{static: true}) prca2400 : ElementRef;
 ...
 ngAfterViewInit(): void {
    ...
    this.dtTrigger.next(null);
    console.log($("body").find("#div-wraper .content .card:first .linkButton"))
  }
