...
@Component({
  selector: 'app-fca0800-head',
  templateUrl: './fca0800-head.component.html',
  styleUrls: ['./fca0800-head.component.scss']
})


export class Fca0800HeadComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.fCaseType();
    this.fCaseTitle(this.fca0800Service.defaultCaseType);
