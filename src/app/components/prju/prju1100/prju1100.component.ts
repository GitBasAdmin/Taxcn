...
@Component({
  selector: 'app-prju1100,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prju1100.component.html',
  styleUrls: ['./prju1100.component.css']
})


export class Prju1100Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prju1100',{static: true}) prju1100 : ElementRef;
  ...
  ngOnInit(): void {
    ...
    //----------------------end pcase_type -------------------
this.getPrintFlag=[{id:'1',text:'พิมพ์แนวตั้ง'},{id:'2',text:'พิมพ์แนวนอน'}];
this.setDefPage();
  }
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "dep_name" : this.result.dep_name ? this.result.dep_name : '',
        ...
        "pprint_flag" : this.result.pprint_flag ? this.result.pprint_flag : '',
       });
