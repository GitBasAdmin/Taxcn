...
@Component({
  selector: 'app-prju0700,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prju0700.component.html',
  styleUrls: ['./prju0700.component.css']
})


export class Prju0700Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prju0700',{static: true}) prju0700 : ElementRef;
