...
@Component({
  selector: 'app-prju2000,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prju2000.component.html',
  styleUrls: ['./prju2000.component.css']
})


export class Prju2000Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prju2000',{static: true}) prju2000 : ElementRef;
