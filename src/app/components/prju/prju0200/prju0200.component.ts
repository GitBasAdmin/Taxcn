...
@Component({
  selector: 'app-prju0200,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prju0200.component.html',
  styleUrls: ['./prju0200.component.css']
})


export class Prju0200Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prju0200',{static: true}) prju0200 : ElementRef;
