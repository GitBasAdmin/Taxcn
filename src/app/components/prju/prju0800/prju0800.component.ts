...
@Component({
  selector: 'app-prju0800,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prju0800.component.html',
  styleUrls: ['./prju0800.component.css']
})


export class Prju0800Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prju0800',{static: true}) prju0800 : ElementRef;
  ...
  ngOnInit(): void {
    ...
    this.getPrintFlag=[{id:'2',text:'พิมพ์แนวตั้ง'},{id:'1',text:'พิมพ์แนวนอน'}];
    this.setDefPage();
  }
 ...
 ngAfterViewInit(): void {
  ...
  ngOnDestroy(): void {
    ...
    clearPsel(val:any){
     if(val==0){
        this.result.pred_id1 = '';
        this.result.pred_id2 = '';
        this.result.pred_yy = '';
      }else{
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "psel" : this.result.psel ? this.result.psel.toString() : '0',
        ...
        "pcase_court_type" : this.userData.courtTypeId ? this.userData.courtTypeId.toString() : '',
        ...
        "pred_id1" : this.result.pred_id1 ? this.result.pred_id1.toString() : '',
        "pred_id2" : this.result.pred_id2 ? this.result.pred_id2.toString() : '',
        "pred_yy" : this.result.pred_yy ? this.result.pred_yy.toString() : '',
