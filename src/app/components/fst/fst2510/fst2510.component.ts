...
@Component({
  ...
  selector: 'app-fst2510,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fst2510.component.html',
  styleUrls: ['./fst2510.component.css']
})


export class Fst2510Component implements AfterViewInit, OnInit, OnDestroy {
  ...
  getData () {
    ...
    this.http.post('/'+this.userData.appName+'ApiST/API/STAT/fst2510/getStatData', student ).subscribe(
      (response) =>{
        let getDataOptions : any = JSON.parse(JSON.stringify(response));
  ...
  buttProcess(){
   ...
   if(!this.result.stat_year){
      ...
      this.http.disableLoading().post('/'+this.userData.appName+'ApiST/API/STAT/fst2510/getStatData', student ).subscribe(
        (response) =>{
  ...
  searchData(){
    ...
    if(!this.result.stat_year){
      ...
      var student = JSON.stringify({
        ...
        console.log(student);
      this.http.post('/'+this.userData.appName+'ApiST/API/STAT/fst2510', student ).subscribe(
        (response) =>{
          let alertMessage : any = JSON.parse(JSON.stringify(response));
  ...
  if (!this.result.stat_year) {
      ...
      console.log(data);
      this.http.disableLoading().post('/'+this.userData.appName+'ApiST/API/STAT/fst2510/saveData', data ).subscribe(
        (response) =>{
          let alertMessage : any = JSON.parse(JSON.stringify(response));
  ...
  confirmSendData(){
    ...
    if(!this.posts.case_type_stat || !this.posts.stat_year || !this.posts.create_user){
      ...
      const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
        if (resp.success==true){
          ...
          this.http.post('/' + this.userData.appName + 'ApiST/API/STAT/fst2510/confirmSendData', student).subscribe(
            (response) => {
              let alertMessage: any = JSON.parse(JSON.stringify(response));
              if (alertMessage.result == 1) {
                confirmBox.setMessage(alertMessage.error);
                ...
                const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
                  if (resp.success==true){
                    this.SpinnerService.hide();
                    this.result.confirm_user=alertMessage.confirm_user;
                    this.result.confirm_date=alertMessage.confirm_date;
                  }
                  subscription.unsubscribe();
                });
              }else{
    ...
    if(!this.posts.case_type_stat || !this.posts.stat_year || !this.posts.create_user){
      ...
      const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
        ...
        if (resp.success==true){
          ...
          this.http.post('/' + this.userData.appName + 'ApiST/API/STAT/fst2510/cancelSendData', student).subscribe(
            (response) => {
              let alertMessage: any = JSON.parse(JSON.stringify(response));
              if (alertMessage.result == 1) {
                confirmBox.setMessage(alertMessage.error);
                ...
                const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
                  if (resp.success==true){
                    this.SpinnerService.hide();
                    this.result.confirm_user="";
                    this.result.confirm_date="";
                  }
                  subscription.unsubscribe();
                });
              }else{
    ...
    if(!this.posts.stat_year || !this.posts.create_user){
      ...
      const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
        if (resp.success==true){
          ...
          this.http.post('/' + this.userData.appName + 'ApiST/API/STAT/fst2510/confirmData', student).subscribe(
            (response) => {
              let alertMessage: any = JSON.parse(JSON.stringify(response));
              if (alertMessage.result == 1) {
                confirmBox.setMessage(alertMessage.error);
    ...
    if(!this.posts.stat_year || !this.posts.create_user){
      ...
      const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
        ...
        if (resp.success==true){
          ...
          this.http.post('/' + this.userData.appName + 'ApiST/API/STAT/fst2510/cancelData', student).subscribe(
            (response) => {
              let alertMessage: any = JSON.parse(JSON.stringify(response));
              if (alertMessage.result == 1) {
                confirmBox.setMessage(alertMessage.error);
