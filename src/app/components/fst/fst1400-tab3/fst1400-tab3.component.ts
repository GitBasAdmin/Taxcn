...
@Component({
  selector: 'app-fst1400-tab3',
  templateUrl: './fst1400-tab3.component.html',
  styleUrls: ['./fst1400-tab3.component.css']
})
export class Fst1400Tab3Component implements OnInit {
  sessData:any;
  userData:any;
  getCaseTypeStat:any;
  getHoldStat:any;
