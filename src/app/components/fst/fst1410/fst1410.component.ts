...
@Component({
  selector: 'app-fst1410,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fst1410.component.html',
  styleUrls: ['./fst1410.component.css']
})


export class Fst1410Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
 ...
 ngAfterViewInit(): void {
  ...
  changeData(){
    ...
    this.http.post('/'+this.userData.appName+'ApiST/API/STAT/fst1410/getStatData', student , {headers:headers}).subscribe(
      (response) =>{
        let getDataOptions : any = JSON.parse(JSON.stringify(response));
        console.log(getDataOptions)
