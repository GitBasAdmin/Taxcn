...
@Component({
  selector: 'app-fst2400-main',
  templateUrl: './fst2400-main.component.html',
  styleUrls: ['./fst2400-main.component.css']
})
export class Fst2400MainComponent implements AfterViewInit, OnInit, OnDestroy {
  caseData:any;
  widthSet:any;
  onUpdateData:any;
  tab_index:any;
