...
@Component({
  selector: 'app-fst1400-tab2',
  templateUrl: './fst1400-tab2.component.html',
  styleUrls: ['./fst1400-tab2.component.css']
})
export class Fst1400Tab2Component implements AfterViewInit, OnInit, OnDestroy {
  sessData:any;
  userData:any;
  getCaseTypeStat:any;
  getHoldStat:any;
