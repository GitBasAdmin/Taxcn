...
@Component({
  selector: 'app-fkb0610,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkb0610.component.html',
  styleUrls: ['./fkb0610.component.css']
})


export class Fkb0610Component implements AfterViewInit, OnInit, OnDestroy {
