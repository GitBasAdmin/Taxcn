...
@Component({
  selector: 'app-prud0300,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prud0300.component.html',
  styleUrls: ['./prud0300.component.css']
})


export class Prud0300Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prud0300',{static: true}) prud0300 : ElementRef;
  ...
  setDefPage(){
    ...
    // this.result.phold = '1';
    this.result.ptoday = myExtObject.curDate();
  }
