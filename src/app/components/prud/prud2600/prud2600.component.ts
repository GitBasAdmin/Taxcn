...
@Component({
  selector: 'app-prud2600,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prud2600.component.html',
  styleUrls: ['./prud2600.component.css']
})


export class Prud2600Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prud2600',{static: true}) prud2600 : ElementRef;
