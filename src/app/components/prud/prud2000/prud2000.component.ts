...
@Component({
  selector: 'app-prud2000,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prud2000.component.html',
  styleUrls: ['./prud2000.component.css']
})


export class Prud2000Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prud2000',{static: true}) prud2000 : ElementRef;
