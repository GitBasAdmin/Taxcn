...
@Component({
  selector: 'app-prud0900,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prud0900.component.html',
  styleUrls: ['./prud0900.component.css']
})


export class Prud0900Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prud0900',{static: true}) prud0900 : ElementRef;
  ...
  setDefPage(){
    ...
    this.result.txtEndDate2 = this.result.txtEndDate2 = myExtObject.curDate();
  }
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "pprint" : this.result.pprint==true ? '1': '',
        ...
        "ptoday" : this.result.txtEndDate2 ? myExtObject.conDate(this.result.txtEndDate2) : '',
       });
