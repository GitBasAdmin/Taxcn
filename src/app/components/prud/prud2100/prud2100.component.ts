...
@Component({
  selector: 'app-prud2100,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prud2100.component.html',
  styleUrls: ['./prud2100.component.css']
})


export class Prud2100Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prud2100',{static: true}) prud2100 : ElementRef;
  ...
  //========================END getToCourt====================================
    ...
    this.getHold=[{id:'1',text:'แจ้งการอ่าน'},{id:'2',text:'ค้างแจ้งการอ่าน'},{id:'3',text:'อ่านคำพิพากษา/คำสั่ง'},{id:'5',text:'อ่านคำพิพากษา/คำสั่ง ส่งภาค'},{id:'6',text:'อ่านคำพิพากษา/คำสั่ง ส่งภาค (แบบภาค)'},{id:'4',text:'ค้างอ่านคำพิพากษา/คำสั่ง'}];
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "pprint_by" : this.pprint_by ? this.pprint_by.toString() : '',
       });
