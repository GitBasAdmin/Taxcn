...
@Component({
  selector: 'app-prud0420,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prud0420.component.html',
  styleUrls: ['./prud0420.component.css']
})


export class Prud0420Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prud0420',{static: true}) prud0420 : ElementRef;
