...
@Component({
  selector: 'app-prud0200,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prud0200.component.html',
  styleUrls: ['./prud0200.component.css']
})


export class Prud0200Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
  ...
  // @ViewChild('prud0200',{static: true}) case_type : ElementRef;
