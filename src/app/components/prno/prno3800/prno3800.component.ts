...
@Component({
  selector: 'app-prno3800,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prno3800.component.html',
  styleUrls: ['./prno3800.component.css']
})


export class Prno3800Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prno3800',{static: true}) prno3800 : ElementRef;
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        "pflag" :this.result.pflag ? this.result.pflag : '0',
