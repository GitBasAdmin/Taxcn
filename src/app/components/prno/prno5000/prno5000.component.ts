...
@Component({
  selector: 'app-prno5000,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prno5000.component.html',
  styleUrls: ['./prno5000.component.css']
})


export class Prno5000Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
  ...
  // @ViewChild('prno5000',{static: true}) case_type : ElementRef;
...
//    )
 ...
 ngAfterViewInit(): void {
  ...
  //  }
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
          ...
          "pnotice_type_name" : this.result.notice_type_name,
    ...
    //     this.http.post('/'+this.userData.appName+'ApiJU/API/JUDGEMENT/prno5000', student , {headers:headers}).subscribe(
    //       (response) =>{
    //           let productsJson : any = JSON.parse(JSON.stringify(response));
    ...
    LoadData() {
      ...
      confirmBox.setTitle('ข้อความแจ้งเตือน');
        ...
        console.log(student);
        this.http.post('/'+this.userData.appName+'ApiFN/API/FINANCE/prno5000', student ).subscribe(
          posts => {
    ...
    //       this.excelService.exportAsExcelFile(objExcel,'prno5000' ,this.programName);
    //     }
