...
@Component({
  selector: 'app-prca3000,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prca3000.component.html',
  styleUrls: ['./prca3000.component.css']
})


export class Prca3000Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
  ...
  // @ViewChild('prca3000',{static: true}) case_type : ElementRef;
  ...
  ngOnInit(): void {
    ...
    var student = JSON.stringify({
      ...
      "field_id": "title",
      "field_name": "title",
      "condition": "AND title_flag='1' AND case_type='"+this.userData.defaultCaseType+"'",
    ...
    var student = JSON.stringify({
      ...
      "field_id": "title",
      "field_name": "title",
      "condition": "AND title_flag='2' AND case_type='"+this.userData.defaultCaseType+"'",
      "order_by": " order_id ASC",
      "userToken" : this.userData.userToken
    });
    this.http.post('/'+this.userData.appName+'ApiUTIL/API/getData', student ).subscribe(
    ...
    printReport(val:any){
     ...
     if(this.dataSearch.length < 1){
      ...
      var paramData = JSON.stringify({
        ...
        "plit_type" : this.result.plit_type,
      });
