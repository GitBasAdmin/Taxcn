...
@Component({
  selector: 'app-prca0500,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prca0500.component.html',
  styleUrls: ['./prca0500.component.css']
})


export class Prca0500Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prca0500',{static: true}) prca0500 : ElementRef;
  ...
  ngOnInit(): void {
    ...
    this.getPrintType = [{id:'1',text:'คู่ความกับพวกรวม'},{id:'2',text:'คู่ความรายบุคคล'}];
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "pprint_type" : this.pprint_type ? this.pprint_type.toString() : '',
