...
@Component({
  selector: 'app-prmg2800,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prmg2800.component.html',
  styleUrls: ['./prmg2800.component.css']
})

export class Prmg2800Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  posts: any;
  ...
  @ViewChild('prmg2800', { static: true }) prmg2800: ElementRef;
