...
@Component({
  selector: 'app-prmg0400,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prmg0400.component.html',
  styleUrls: ['./prmg0400.component.css']
})


export class Prmg0400Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prmg0400',{static: true}) prmg0400 : ElementRef;
