...
@Component({
  selector: 'app-fct0218,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fct0218.component.html',
  styleUrls: ['./fct0218.component.css']
})


export class Fct0218Component implements AfterViewInit, OnInit, OnDestroy {
  ...
  @ViewChild('case_type',{static: true}) case_type : ElementRef;
  ...
  ngOnInit(): void {
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      this.http.get('/'+this.userData.appName+'ApiCT/API/fct0218?userToken='+this.userData.userToken+':angular').subscribe(posts => {
 ...
 ngAfterViewInit(): void {
  ...
  setFocus(name:any) {
    const ele = this.case_type.nativeElement[name];
    if (ele) {
      ele.focus();
    }
  }
  ...
  submitForm() {
    ...
    if(!this.case_type.nativeElement["case_type"].value){
      confirmBox.setMessage('กรุณาระบุรหัสประเภทความ');
      confirmBox.setButtonLabels('ตกลง');
      confirmBox.setConfig({
          layoutType: DialogLayoutDisplay.WARNING // SUCCESS | INFO | NONE | DANGER | WARNING
      });
      const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
        if (resp.success==true){
          //this.SpinnerService.hide();
          this.setFocus('case_type');
        }
        subscription.unsubscribe();
      });

    }else if(!this.case_type.nativeElement["case_type_desc"].value){
      ...
      var student = JSON.stringify({
        "case_type" : this.case_type.nativeElement["case_type"].value,
        "edit_case_type" : this.case_type.nativeElement["hid_case_type"].value,
        "case_type_desc" : this.case_type.nativeElement["case_type_desc"].value,
      ...
      this.SpinnerService.show();
      if(this.case_type.nativeElement["hid_case_type"].value){
        this.http.post('/'+this.userData.appName+'ApiCT/API/fct0218/updateJson', student , {headers:headers}).subscribe(
          (response) =>{
        ...
        this.http.post('/'+this.userData.appName+'ApiCT/API/fct0218/saveJson', student , {headers:headers}).subscribe(
          (response) =>{
            let alertMessage : any = JSON.parse(JSON.stringify(response));
  ...
  editData(val :any) {
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
    this.SpinnerService.show();
    //console.log('/'+this.userData.appName+'ApiCT/API/fct0218/edit?edit_case_type='+val+'&userToken='+this.userData.userToken+':angular')
    this.http.get('/'+this.userData.appName+'ApiCT/API/fct0218/edit?edit_case_type='+val+'&userToken='+this.userData.userToken+':angular').subscribe(edit => {
      //console.log(edit)
      this.SpinnerService.hide();
      ...
      if(productsJson.result==0){
        ...
        this.renderer.setProperty(this.case_type.nativeElement['hid_case_type'],'value', productsJson.data[0]['edit_case_type']);
        this.renderer.setProperty(this.case_type.nativeElement['case_type'],'value', productsJson.data[0]['case_type']);
        this.renderer.setProperty(this.case_type.nativeElement['case_type_desc'],'value', productsJson.data[0]['case_type_desc']);
  ...
  searchData() {
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      console.log(student)
      this.http.post('/'+this.userData.appName+'ApiCT/API/fct0218/search', student , {headers:headers}).subscribe(
        posts => {
          let productsJson : any = JSON.parse(JSON.stringify(posts));
          this.posts = productsJson.data;
          console.log(productsJson)
        ...
        posts => {
          ...
          if(productsJson.result==1){
            ...
            const subscription = confirmBox.openConfirmBox$().subscribe(resp => {
                if (resp.success==true){
                  this.SpinnerService.show();
                  this.http.get('/'+this.userData.appName+'ApiCT/API/fct0218/delete?delete_case_type='+this.delValue+'&userToken='+this.userData.userToken+':angular').subscribe(del => {
                  console.log(del);
