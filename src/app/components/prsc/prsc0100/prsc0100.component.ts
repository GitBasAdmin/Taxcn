...
@Component({
  selector: 'app-prsc0100,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prsc0100.component.html',
  styleUrls: ['./prsc0100.component.css']
})


export class Prsc0100Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prsc0100',{static: true}) prsc0100 : ElementRef;
  ...
  ngOnInit(): void {
    ...
    this.getDepartment = [{id:'',text:'ทั้งหมด'},{id:'1',text:'สถานีตำรวจ'},{id:'2',text:'หน่วยงานภายนอก'}];
    this.setDefPage();
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        "pdepartment" : this.result.pdepartment ? this.result.pdepartment.toString() : '',
        ...
        "ptime_start" : this.result.ptime_start ? this.result.ptime_start.toString() : '',
        "ptime_end" : this.result.ptime_end ? this.result.ptime_end.toString() : '',
