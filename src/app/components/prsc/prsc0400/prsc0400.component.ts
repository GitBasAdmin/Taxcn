...
@Component({
  selector: 'app-prsc0400,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prsc0400.component.html',
  styleUrls: ['./prsc0400.component.css']
})


export class Prsc0400Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prsc0400',{static: true}) prsc0400 : ElementRef;
