...
@Component({
  selector: 'app-prsc0200,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prsc0200.component.html',
  styleUrls: ['./prsc0200.component.css']
})


export class Prsc0200Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prsc0200',{static: true}) prsc0200 : ElementRef;
