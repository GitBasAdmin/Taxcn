...
@Component({
  selector: 'app-prsc0700,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prsc0700.component.html',
  styleUrls: ['./prsc0700.component.css']
})


export class Prsc0700Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
