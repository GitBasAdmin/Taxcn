...
@Component({
  selector: 'app-prsc0900,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prsc0900.component.html',
  styleUrls: ['./prsc0900.component.css']
})


export class Prsc0900Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prsc0900',{static: true}) prsc0900 : ElementRef;
