...
@Component({
  selector: 'app-fgu0140,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fgu0140.component.html',
  styleUrls: ['./fgu0140.component.css']
})


export class Fgu0140Component implements AfterViewInit, OnInit, OnDestroy {
  ...
  public loadFgu0140Component : boolean = false;
  ...
  ngOnInit(): void {
    ...
    //   this.http.disableLoading().post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0140/getGuarantorData', student).subscribe(
    //     (response) =>{
...
// }
  ...
  submitForm() {
    ...
    //   });
      ...
      // formData.append('file', this.fileToUpload0);
  ...
  AssignData(obj:any){
    ...
    var objData = obj;
      ...
      // this.result.guar_name = objData[0].guar_title + objData[0].guar_name;
      // this.result.edit_guarman_item  = objData[0].edit_guarman_item;
      // this.result.edit_asset_item  = objData[0].edit_asset_item;
      // this.result.asset_item  = objData[0].edit_asset_item;
      // this.result.asset_amt = objData[0].asset_amt;
  ...
  searchData() {
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      console.log(student)
      this.http.post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0140/search', student , {headers:headers}).subscribe(
        posts => {
...
closeModal(){
  ...
  getData(){
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      this.SpinnerService.show();
      this.http.get('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0140?userToken='+this.userData.userToken+':angular').subscribe(posts => {
          let productsJson : any = JSON.parse(JSON.stringify(posts));
          console.log(productsJson)
          this.posts = productsJson.data;
          console.log(this.posts);
