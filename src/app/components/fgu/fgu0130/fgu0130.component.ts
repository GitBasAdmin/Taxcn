...
@Component({
  selector: 'app-fgu0130,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fgu0130.component.html',
  styleUrls: ['./fgu0130.component.css']
})


export class Fgu0130Component implements AfterViewInit, OnInit, OnDestroy {
  ...
  public loadFgu0130Component : boolean = false;
  ...
  ngOnInit(): void {
    ...
    //   this.http.disableLoading().post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0130/getGuarantorData', student).subscribe(
    //     (response) =>{
...
this.getLandType = [{id: 1,text: 'น.ส.3'},{id: 2,text: 'น.ส.3ก'},{id: 3,text: 'โฉนด'},{id: 4,text: 'น.ส.4'},{id: 5,text: 'หนังสือรับรองการทำประโยชน์'},{id: 6,text: 'อื่นๆ'}];
this.getAssetId();
if(this.result.guarman_item){
  ...
  getGuarantorId(){
    ...
    this.http.post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0130/runItem', student).subscribe(
      (response) =>{
        let getDataOptions : any = JSON.parse(JSON.stringify(response));
  ...
  getGuarmanItem(){
    ...
    this.http.post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0130/getGuarantorData', student).subscribe(
      (response) =>{
        let getDataOptions : any = JSON.parse(JSON.stringify(response));
...
// }
  ...
  editData(index:any){
    ...
    this.SpinnerService.show();
      ...
      // this.result.ltambon_id = this.posts[index]['tambon_id'];
      // this.result.lamphur_id = this.posts[index]['amphur_id'];
      this.result.lprov_id = this.posts[index]['prov_id'];
      if(this.result.lprov_id)
      this.changeProv(this.result.lprov_id,'');
       else{
  ...
  AssignData(obj:any){
    ...
    var objData = obj;
      ...
      this.result.lprov_id = objData[0].lprov_id;
      if(this.result.lprov_id)
      this.changeProv(this.result.lprov_id,'');
       else{
        this.sAmphur.clearModel();
      ...
      this.edit_amphur_id = objData[0].lamphur_id;
      this.edit_tambon_id = objData[0].ltambon_id;
  ...
  searchData() {
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      console.log(student)
      this.http.post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0130/search', student , {headers:headers}).subscribe(
        posts => {
    ...
    (response) =>{
      ...
      setTimeout(() => {
        if(this.edit_amphur_id)
          this.result.lamphur_id = this.edit_amphur_id;
        if(this.edit_amphur_id){
          this.changeAmphur(this.result.lamphur_id,type);
        }
      }, 100);
...
changeAmphur(Amphur:any,type:any){
  ...
  var student = JSON.stringify({
    ...
    "condition" : " AND amphur_id='"+Amphur+"' AND prov_id='"+this.result.lprov_id+"'",
    "userToken" : this.userData.userToken
  });
  //console.log(student)
  this.http.post('/'+this.userData.appName+'ApiUTIL/API/getData', student , {headers:headers}).subscribe(
    (response) =>{
      ...
      setTimeout(() => {
        if(this.edit_tambon_id)
          this.result.ltambon_id = this.edit_tambon_id;
      }, 100);
    },
    (error) => {}
  )
...
changeTambon(Tambon:any,type:any){
  ...
  var student = JSON.stringify({
    ...
    "condition" : " AND tambon_id='"+Tambon+"' AND amphur_id='"+this.result.lamphur_id+"' AND prov_id='"+this.result.lprov_id+"'",
    "userToken" : this.userData.userToken
  });
  //console.log(student);
  this.http.post('/'+this.userData.appName+'ApiUTIL/API/getData', student , {headers:headers}).subscribe(
    (response) =>{
      ...
      setTimeout(() => {
        this.result.post_code = this.getPostNo.find((o:any) => o.fieldIdValue === this.result.ltambon_id).fieldNameValue2;
      }, 100);
    },
    (error) => {}
  )
...
closeModal(){
  ...
  getData(){
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      this.SpinnerService.show();
      this.http.get('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0130?userToken='+this.userData.userToken+':angular').subscribe(posts => {
          let productsJson : any = JSON.parse(JSON.stringify(posts));
          console.log(productsJson)
          this.posts = productsJson.data;
          console.log(this.posts);
