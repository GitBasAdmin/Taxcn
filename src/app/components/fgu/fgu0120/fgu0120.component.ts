...
@Component({
  selector: 'app-fgu0120,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fgu0120.component.html',
  styleUrls: ['./fgu0120.component.css']
})


export class Fgu0120Component implements AfterViewInit, OnInit, OnDestroy {
  ...
  public loadFgu0120Component : boolean = false;
  ...
  ngOnInit(): void {
    ...
    //   this.http.disableLoading().post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0120/getGuarantorData', student).subscribe(
    //     (response) =>{
...
if(this.result.guarman_item){
  ...
  getGuarantorId(){
    ...
    this.http.post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0120/runItem', student).subscribe(
      (response) =>{
        let getDataOptions : any = JSON.parse(JSON.stringify(response));
  ...
  getGuarmanItem(){
    ...
    this.http.post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0120/getGuarantorData', student).subscribe(
      (response) =>{
        let getDataOptions : any = JSON.parse(JSON.stringify(response));
...
// }
  ...
  searchData() {
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      console.log(student)
      this.http.post('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0120/search', student , {headers:headers}).subscribe(
        posts => {
...
closeModal(){
  ...
  getData(){
    ...
    confirmBox.setTitle('ข้อความแจ้งเตือน');
      ...
      this.SpinnerService.show();
      this.http.get('/'+this.userData.appName+'ApiGU/API/GUARANTEE/fgu0120?userToken='+this.userData.userToken+':angular').subscribe(posts => {
          let productsJson : any = JSON.parse(JSON.stringify(posts));
          console.log(productsJson)
          this.posts = productsJson.data;
          console.log(this.posts);
