...
@Component({
  selector: 'app-prap0900,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prap0900.component.html',
  styleUrls: ['./prap0900.component.css']
})


export class Prap0900Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  posts:any;
  ...
  @ViewChild('prap0900',{static: true}) prap0900 : ElementRef;
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        //  "pcase_type" : this.selCaseType,
         ...
         "ptable_id" : this.result.ptable_id,
