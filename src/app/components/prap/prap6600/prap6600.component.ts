...
@Component({
  selector: 'app-prap6600,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prap6600.component.html',
  styleUrls: ['./prap6600.component.css']
})


export class Prap6600Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prap6600',{static: true}) prap6600 : ElementRef;
