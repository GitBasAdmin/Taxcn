...
@Component({
  selector: 'app-prap4800,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prap4800.component.html',
  styleUrls: ['./prap4800.component.css']
})


export class Prap4800Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prap4800',{static: true}) prap4800 : ElementRef;
