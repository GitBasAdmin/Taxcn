...
@Component({
  selector: 'app-prap3000,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prap3000.component.html',
  styleUrls: ['./prap3000.component.css']
})


export class Prap3000Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prap3000',{static: true}) prap3000 : ElementRef;
  ...
  assignTable(val:any){
    ...
    this.http.post('/'+this.userData.appName+'ApiUTIL/API/getData', Json ).subscribe(
      (response) =>{
        ...
        this.result.ptable_id = getDataOptions[0].fieldIdValue;
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "ptable_type" : this.result.ptable_type ? this.result.ptable_type.toString() : '1',
