...
@Component({
  selector: 'app-prdo1200,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prdo1200.component.html',
  styleUrls: ['./prdo1200.component.css']
})


export class Prdo1200Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prdo1200',{static: true}) prdo1200 : ElementRef;
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        "pcase_title" : this.result.pcase_title ? this.result.pcase_title.toString() : '0',
