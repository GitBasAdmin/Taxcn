...
@Component({
  selector: 'app-prdo1300,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prdo1300.component.html',
  styleUrls: ['./prdo1300.component.css']
})


export class Prdo1300Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prdo1300',{static: true}) prdo1300 : ElementRef;
 ...
 ngAfterViewInit(): void {
  ...
  ngOnDestroy(): void {
    ...
    printReport(type:any){
      var pflag=0;
      if(type==1){//พิมพ์บาร์โค้ด(เครื่องพิมพ์ barcode)
        pflag=1;
      }else if(type==2){////พิมพ์บาร์โค้ด(Label 3)
        pflag=2;
      }else if(type==3){////พิมพ์บาร์โค้ด(Label 4)
        pflag=3;
      }
