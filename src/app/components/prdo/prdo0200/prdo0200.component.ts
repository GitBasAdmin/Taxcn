...
@Component({
  selector: 'app-prdo0200,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prdo0200.component.html',
  styleUrls: ['./prdo0200.component.css']
})


export class Prdo0200Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prdo0200',{static: true}) prdo0200 : ElementRef;
