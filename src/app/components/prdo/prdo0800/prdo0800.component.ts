...
@Component({
  selector: 'app-prdo0800,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prdo0800.component.html',
  styleUrls: ['./prdo0800.component.css']
})


export class Prdo0800Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prdo0800',{static: true}) prdo0800 : ElementRef;
  ...
  setDefPage(){
    ...
    this.result.puser_id = this.userData.userCode;
  ...
  tabChangeInput(name:any,event:any){
    if(name=='pdep_code'){
      ...
      var student = JSON.stringify({
        ...
        "field_name" : "off_name",
        "field_name2" : "post_id",
        "condition" : " AND off_id='"+event.target.value+"' AND dep_code='"+this.result.pdep_code+"'",
        "userToken" : this.userData.userToken
      });
        console.log(student)
        this.http.post('/'+this.userData.appName+'ApiUTIL/API/getData', student ).subscribe(
    ...
    loadMyModalComponent(){
      ...
      if(this.modalType==1){
        ...
        var student = JSON.stringify({
          ...
          "field_name" : "off_name",
          "field_name2" : "post_id",
          "condition" : " AND dep_code='"+this.result.pdep_code+"'",
          "search_id" : "",
          "search_desc" : "",
          "userToken" : this.userData.userToken});
        ...
        this.listFieldCond=" AND dep_code='"+this.userData.depCode+"'";
        this.listFieldNull='';
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "puser_id" : this.result.puser_id ? this.result.puser_id : '',
