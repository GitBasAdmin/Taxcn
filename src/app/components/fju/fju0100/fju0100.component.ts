...
@Component({
  selector: 'app-fju0100,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fju0100.component.html',
  styleUrls: ['./fju0100.component.css']
})


export class Fju0100Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
 ...
 ngAfterViewInit(): void {
  ...
  callDataHead(objData:any){//ส่งไปเรียก fju0100-head
    console.log(objData)
    this.callHead = objData;
  }

  fnDataHead(objData:any){//รับจาก fju0100-head
    console.log(objData)
