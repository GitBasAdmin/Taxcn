...
@Component({
  selector: 'app-datalist-return-multiple-dep',
  templateUrl: './datalist-return-multiple-dep.component.html',
  styleUrls: ['./datalist-return-multiple-dep.component.css']
})
export class DatalistReturnMultipleDepComponent implements AfterViewInit,OnInit {
  @Input() items : any = [];
