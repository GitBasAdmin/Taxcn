...
@Component({
  selector: 'app-print-send-notice',
  templateUrl: './print-send-notice.component.html',
  styleUrls: ['./print-send-notice.component.css']
})
export class PrintSendNoticeComponent implements AfterViewInit,OnInit,AfterContentInit {
  sessData:any;
  userData:any;
  result:any = [];
  getCaseType:any=[];
...
getMessage(){
  ...
  confirmBox.setMessage('กรุณาระบุข้อมูล เลขที่อ้างอิง');
...
async getWithdrawRunno(type:any){
