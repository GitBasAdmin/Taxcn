...
@Component({
  selector: 'app-fkn0900-pjudgement,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0900-pjudgement.component.html',
  styleUrls: ['./fkn0900-pjudgement.component.css']
})


export class Fkn0900PjudgementComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  searchData(student:any){
    ...
    this.http.post('/' + this.userData.appName + 'ApiKN/API/KEEPN/fkn0900/getJudgementData', student.sendData,).subscribe(posts => {
