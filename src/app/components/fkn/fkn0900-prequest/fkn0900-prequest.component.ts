...
@Component({
  selector: 'app-fkn0900-prequest,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0900-prequest.component.html',
  styleUrls: ['./fkn0900-prequest.component.css']
})


export class Fkn0900PrequestComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  searchData(student:any){
    ...
    this.http.post('/' + this.userData.appName + 'ApiKN/API/KEEPN/fkn0900/getRequestData', student.sendData,).subscribe(posts => {
