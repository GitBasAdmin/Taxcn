...
@Component({
  selector: 'app-fkn0900-pappointment,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0900-pappointment.component.html',
  styleUrls: ['./fkn0900-pappointment.component.css']
})


export class Fkn0900PappointmentComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  searchData(student:any){
    ...
    this.http.post('/' + this.userData.appName + 'ApiKN/API/KEEPN/fkn0900/getAppointment', student.sendData,).subscribe(posts => {
