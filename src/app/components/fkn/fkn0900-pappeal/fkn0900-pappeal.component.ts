...
@Component({
  selector: 'app-fkn0900-pappeal,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0900-pappeal.component.html',
  styleUrls: ['./fkn0900-pappeal.component.css']
})


export class Fkn0900PappealComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  searchData(student:any){
    ...
    this.http.post('/' + this.userData.appName + 'ApiKN/API/KEEPN/fkn0900/getAppeal', student.sendData,).subscribe(posts => {
