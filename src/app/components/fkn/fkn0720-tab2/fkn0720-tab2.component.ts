...
@Component({
  selector: 'app-fkn0720-tab2,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0720-tab2.component.html',
  styleUrls: ['./fkn0720-tab2.component.css']
})


export class Fkn0720Tab2Component implements AfterViewInit, OnInit, OnDestroy {
  ...
  getData(){
    ...
    this.http.post('/'+this.userData.appName+'ApiKN/API/KEEPN/fkn0720/getDataTab2', student).subscribe(posts => {
      let productsJson : any = JSON.parse(JSON.stringify(posts));
      
      // console.log("productsJson2=>", productsJson.data);
      if(productsJson.result==1){
        ...
        if(productsJson.data.length)
          this.posts.forEach((x : any ) => x.edit0722 = false);
        this.rerender();
      }else{
 ...
 ngAfterViewInit(): void {
  ...
  checkUncheckAll() {
    for (var i = 0; i < this.checklist.length; i++) {
      this.checklist[i].edit0722 = this.masterSelected;
      }
  }

  isAllSelected() {
    this.masterSelected = this.checklist.every(function(item:any) {
        return item.edit0722 == true;
    })
  }

  uncheckAll() {
    for (var i = 0; i < this.checklist.length; i++) {
      this.checklist[i].edit0722 = false;
    }
    this.masterSelected = false;
          ...
          if(productsJson.result==1){
              ...
              if (resp.success==true){
                ...
                if(bar){
                  ...
                  this.http.post('/'+this.userData.appName+'ApiKN/API/KEEPN/fkn0720/deleteDataSelectTab2', data ).subscribe(
                  (response) =>{
