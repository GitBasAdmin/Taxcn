...
@Component({
  selector: 'app-fkn0900-pcase-alle-stat,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0900-pcase-alle-stat.component.html',
  styleUrls: ['./fkn0900-pcase-alle-stat.component.css']
})


export class Fkn0900PcaseAlleStatComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  searchData(student:any){
    ...
    this.http.post('/' + this.userData.appName + 'ApiKN/API/KEEPN/fkn0900/getCaseAlleStatData', student.sendData,).subscribe(posts => {
