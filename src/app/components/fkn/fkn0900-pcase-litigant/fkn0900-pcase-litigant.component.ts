...
@Component({
  selector: 'app-fkn0900-pcase-litigant,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0900-pcase-litigant.component.html',
  styleUrls: ['./fkn0900-pcase-litigant.component.css']
})


export class Fkn0900PcaseLitigantComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  searchData(student:any){
    ...
    this.http.post('/' + this.userData.appName + 'ApiKN/API/KEEPN/fkn0900/getCaseLitigantData', student.sendData,).subscribe(posts => {
