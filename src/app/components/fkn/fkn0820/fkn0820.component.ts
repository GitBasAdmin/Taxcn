...
@Component({
  selector: 'app-fkn0820,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './fkn0820.component.html',
  styleUrls: ['./fkn0820.component.css']
})


export class Fkn0820Component implements AfterViewInit, OnInit, OnDestroy {
  //form: FormGroup;
  title = 'datatables';
