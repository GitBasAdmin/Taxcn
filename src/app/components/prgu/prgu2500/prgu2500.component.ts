...
@Component({
  selector: 'app-prgu2500,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prgu2500.component.html',
  styleUrls: ['./prgu2500.component.css']
})


export class Prgu2500Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prgu2500',{static: true}) prgu2500 : ElementRef;
