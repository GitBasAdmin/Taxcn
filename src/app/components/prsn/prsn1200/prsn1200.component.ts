...
@Component({
  selector: 'app-prsn1200,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prsn1200.component.html',
  styleUrls: ['./prsn1200.component.css']
})


export class Prsn1200Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prsn1200',{static: true}) prsn1200 : ElementRef;
...
this.getPostType = [{id:'1',text:'EMS'},{id:'2',text:'ลงทะเบียนตอบรับ'}];
