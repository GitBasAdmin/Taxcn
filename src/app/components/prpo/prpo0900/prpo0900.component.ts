...
@Component({
  selector: 'app-prpo0900,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prpo0900.component.html',
  styleUrls: ['./prpo0900.component.css']
})


export class Prpo0900Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prpo0900', { static: true }) prpo0900: ElementRef;
