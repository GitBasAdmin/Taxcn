...
@Component({
  selector: 'app-prpo0300,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prpo0300.component.html',
  styleUrls: ['./prpo0300.component.css']
})


export class Prpo0300Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prpo0300', { static: true }) prpo0300: ElementRef;
  ...
  ngOnInit(): void {
    ...
    this.getPrintFlag = [{ id: '0', text: 'ทั้งหมด' }, { id: '1', text: 'ไม่รวมคดีที่ฟ้อง' }, { id: '2', text: 'เฉพาะคดีที่ฟ้องแล้ว' }];
    this.setDefPage();
