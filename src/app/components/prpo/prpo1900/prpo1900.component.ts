...
@Component({
  selector: 'app-prpo1900,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prpo1900.component.html',
  styleUrls: ['./prpo1900.component.css']
})


export class Prpo1900Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  posts: any;
  ...
  @ViewChild('prpo1900', { static: true }) prpo1900: ElementRef;
