...
@Component({
  selector: 'app-prpo1500,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prpo1500.component.html',
  styleUrls: ['./prpo1500.component.css']
})


export class Prpo1500Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prpo1500', { static: true }) prpo1500: ElementRef;
