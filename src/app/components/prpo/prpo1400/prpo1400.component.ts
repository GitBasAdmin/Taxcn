...
@Component({
  selector: 'app-prpo1400,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prpo1400.component.html',
  styleUrls: ['./prpo1400.component.css']
})


export class Prpo1400Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('prpo1400', { static: true }) prpo1400: ElementRef;
  ...
  printReport() {
    ...
    var paramData = JSON.stringify({
      ...
      "pmonth_name": this.result.pmonth_name ? this.result.pmonth_name.toString() : '',
    });
