...
@Component({
  selector: 'app-prkb1000,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prkb1000.component.html',
  styleUrls: ['./prkb1000.component.css']
})

export class Prkb1000Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  posts: any;
  ...
  @ViewChild('prkb1000', { static: true }) prkb1000: ElementRef;
