...
@Component({
  selector: 'app-prkb1100,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prkb1100.component.html',
  styleUrls: ['./prkb1100.component.css']
})

export class Prkb1100Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  posts: any;
  ...
  @ViewChild('prkb1100', { static: true }) prkb1100: ElementRef;
