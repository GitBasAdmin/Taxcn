...
@Component({
  selector: 'app-prkb0800,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './prkb0800.component.html',
  styleUrls: ['./prkb0800.component.css']
})


export class Prkb0800Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject: any;
  //form: FormGroup;
  title = 'datatables';
  ...
  ngOnInit(): void {
    ...
    //----------------------end pcase_type -------------------
    this.getOrder = [{ id: '1', text: 'รหัสคู่ความ' }, { id: '2', text: 'เลขคดีดำ' }];
  }
  ...
  printReport() {
    ...
    var paramData = JSON.stringify({
      "puser_name": this.result.poff_name ? this.result.poff_name.toString() : '',
