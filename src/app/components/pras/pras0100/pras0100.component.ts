...
@Component({
  selector: 'app-pras0100,ngbd-popover-basic,ngbd-popover-tplcontent',
  templateUrl: './pras0100.component.html',
  styleUrls: ['./pras0100.component.css']
})


export class Pras0100Component implements AfterViewInit, OnInit, OnDestroy {
  myExtObject :any;
  //form: FormGroup;
  title = 'datatables';
  ...
  @ViewChild('pras0100',{static: true}) pras0100 : ElementRef;
...
var Json = JSON.stringify({
  "table_name" : "passet_title",
  "field_id" : "asset_type",
  "field_name" : "asset_group_title",
  "userToken" : this.userData.userToken
});
  console.log(Json);
    ...
    printReport(){
      ...
      // For set parameter to report
       var paramData = JSON.stringify({
        ...
        "passet_title" : this.passet_title,
       });
